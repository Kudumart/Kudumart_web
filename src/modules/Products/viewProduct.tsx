              ...
              <div className="lg:w-[35%] md:w-[45%] w-full flex flex-col gap-4">
                ...
                <div className="w-full flex flex-col gap-3 py-5 md:px-8 px-4 rounded-md bg-white shadow shadow-md">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {sharePlatforms.map((platform) => (
                      <a
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-md border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-medium"
                      >
                        {platform.icon}
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-md border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-medium w-full"
                  >
                    {copied ? (
                      <>
