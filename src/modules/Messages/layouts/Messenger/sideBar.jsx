...
const UserCard = ({ user, currentUser, onClick, isSelected }) => {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full flex items-center gap-3 px-4 py-3 text-left transition-colors hover:bg-orange-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 ${
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-500 truncate">{lastMessage?.content || "No messages yet"}</p>
      </div>
    </button>
  );
};
