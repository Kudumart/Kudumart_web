    ...
    <>
      <div className="All">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-lg font-semibold text-black-700 mb-4">
            My Stores
          </h1>
          <Link
            to="/admin/new-stores"
              ...
              <tbody>
                {data.map((store, index) => (
                  ...
                  >
                    ...
                    <td className="py-6 px-4 text-left">
                      {dateFormat(store.createdAt, "dd-MM-YYY")}
                    </td>
                    {/*<td className="py-6 px-4 text-left">
                                            <span
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() => navigate(`update/${store.id}`)}
                            >
                              Update
                            </span>
                          </MenuItem>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() => handleDeleteModal(store.id)}
                            >
                              Delete
                            </span>
                          </MenuItem>
